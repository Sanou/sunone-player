...
static void init(Configuration configuration) throws SunoneException{
		...
		for(;iterator.hasNext();)
		{
			...
			{
				throw new SunoneException(
						"PUserState.init Error getting object for State: "
	...
	public static SunoneState getStateObject(SunoneStates state)throws SunoneException {
