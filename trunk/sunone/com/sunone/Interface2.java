...
public class Interface2 extends JXFrame{
	public Component mediaVisuel;
	public static ImageIcon fleche;
	public static String[] saveData={" "," "," "," "};
	private static final long serialVersionUID = 1L;
	public static Interface2 thisClass=null;
	static Boolean b;
   ...
   private JPanel getJPanel1() {
			...
			Image image;
			try {
			    image = ImageIO.read(getClass().getResource("fond1.gif"));
	...
	private JButton getJButton() {
		if (jButton == null) {
			...
			jButton.setIcon(new ImageIcon(getClass().getResource("/com/sunone/previous.png")));
	...
	private JButton getJButton1() {
		if (jButton1 == null) {
			...
			jButton1.setIcon(new ImageIcon(getClass().getResource("/com/sunone/play.png")));
	...
	private JButton getJButton2() {
		if (jButton2 == null) {
			...
			jButton2.setIcon(new ImageIcon(getClass().getResource("/com/sunone/pause.png")));
	...
	private JButton getJButton3() {
		if (jButton3 == null) {
			...
			jButton3.setIcon(new ImageIcon(getClass().getResource("/com/sunone/stop.png")));
	...
	private JButton getJButton4() {
		if (jButton4 == null) {
			...
			jButton4.setIcon(new ImageIcon(getClass().getResource("/com/sunone/next.png")));
		    ...
		    jTable.addMouseListener(new MouseListener(){
				...
				public void mouseClicked(MouseEvent e){
		    		if(e.getClickCount()==2){
		    			Interface2.thisClass.jTable.setValueAt(" ",Lecteur.CURRENTINDEXMEDIA, 0);
		...
		if (jMenuItem12 == null) {
			...
			jMenuItem12.addActionListener(new ActionListener(){
	        	public void actionPerformed(ActionEvent e){
					...
					Interface2.thisClass.jScrollPane.getVerticalScrollBar().setValue(((4*414)/23)*(Lecteur.CURRENTINDEXMEDIA/4));
					Interface2.thisClass.jTable.setValueAt(Interface2.fleche,Lecteur.CURRENTINDEXMEDIA, 0);
	        		}catch(Exception ex){}
	        		}	        	
	        });
		}
...
String themepack = args;
	...
	private void initialize2()throws Exception{
		...
		if(k==0){
			BufferedReader br=new BufferedReader(new FileReader(new File("com\\sunone\\playlist\\current_playlist.pl")));
		    br.close();	
		}
	}
	@SuppressWarnings("deprecation")
	private void initialize() throws Exception{
		...
		this.setIconImage(Toolkit.getDefaultToolkit().getImage(getClass().getResource("/com/sunone/sunone.png")));
		// la fleche d'indication de la playlist encours
		fleche=new ImageIcon(getClass().getResource("/com/sunone/fleche.png"));	
		//this.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		this.setBackground(new Color(204, 255, 224));
		//recuperation de l'URL de la currentplaylist
		String st=new File("com\\sunone\\playlist\\current_playlist.pl").toURL().getPath().toString();
